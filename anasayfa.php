...
<body>
   ...
   <div class="content">
    ...
    <span>wStats Sporcu Seçim Karar Destek Sistemi</span>	
	   ...
	   <div class="main">
			<div class="baslikas">
			<span class="baslikasyazi">Ana Sayfa</span>
			</div>
    ...
    <div class="row">
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-blue order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Sporcu Sayısı</h6>
                    <h2 class="text-right"><i class="fas fa-id-badge f-left"></i><span>35</span></h2>
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-green order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Takım Sayısı</h6>
                    <h2 class="text-right"><i class="fas fa-basketball-ball f-left"></i><span>7</span></h2>
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-yellow order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Gözlem Sayısı</h6>
                    <h2 class="text-right"><i class="fa fa-eye f-left"></i><span>35</span></h2>
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-pink order-card">
                <div class="card-block">
                    <h6 class="m-b-20">Ölçüm Sayısı</h6>
                    <h2 class="text-right"><i class="fas fa-chart-area f-left"></i><span>35</span></h2>
  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Takımların Oyuncu Sayıları',
